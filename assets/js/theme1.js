...
(function ($) {
  ...
  $(document).ready(function() {
		var portfolio_link = window.location.href.split('?')[1].split('=')[1]*1;
		$(".isotope-filter-links").children()[portfolio_link].children[0].classList.add('active');
		$(".isotope-filter-links").children()[portfolio_link].children[0].click()
		$(".isotope-filter-links").children()[0].children[0].classList.remove('active');
	})
	...
	// init Isotope
  var $container = $('.isotope-items-wrap.lightgallery.gsi-color');
  var $container2 = $('.isotope-items-wrap.lightgallery.anim');
		// if RTL enabled
		var origLeft = true;
		if( $('body').hasClass('tt-rtl')) {
			origLeft = false;
	...
	// Filter
	$('.isotope-filter-links.port a').on("click",function(){
  ...
  $('.isotope-filter-links.anim a').on("click",function(){
		var selector = $(this).attr('data-filter');
		$container2.isotope({
			filter: selector
		});
	...
	// Filter item active
	var filterItemActive = $('.isotope-filter-links.port a');
  ...
  var filterItemActive2 = $('.isotope-filter-links.anim a');
	filterItemActive2.on('click', function(){
		var $this = $(this);
		if ( !$this.hasClass('active')) {
			filterItemActive2.removeClass('active');
			$this.addClass('active');
		}
	});
	...
	$(window).scroll(function(){
		...
		$('.parallax-bg-1').css('background-position','center ');
		$('.parallax-bg-2').css('background-position','center ');
		$('.parallax-bg-3').css('background-position','center ');
		$('.parallax-bg-4').css('background-position','center ');
		$('.parallax-bg-5').css('background-position','center ');
		$('.parallax-bg-6').css('background-position','center ');
